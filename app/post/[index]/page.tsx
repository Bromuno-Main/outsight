// app/post/[index]/page.tsx
import React from 'react';
import { posts, Post } from '@/app/data/posts'; // Adjust path if needed
...
export default function PostPage({ params }: { params: { index: string } }) {
  ...
  return (
    <div className="">
      <div className="w-screen py-12 bg-[#105745] z-[1000] relative  ">
        <div className='w-screen sticky top-0 z-10 mx-auto max-w-screen-xl bg-[#105745]  '> <img src={'/insights-logo-white.svg'} alt={'Logo'}/> </div>
